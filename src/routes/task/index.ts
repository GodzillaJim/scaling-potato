...
router.route('/id').post([mainLimiter, AuthChecker.isAuthenticated, AuthChecker.isAuthorized(Role.END_USER), validators.validateInput(TaskID), TaskController.getTaskById])
